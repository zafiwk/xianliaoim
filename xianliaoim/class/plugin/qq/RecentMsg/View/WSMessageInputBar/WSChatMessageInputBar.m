...
@interface WSChatMessageInputBar ()<UITextViewDelegate,emojiViewSelectDelegate>
{
    /**
...
#pragma mark 用手机设备符适配
        ...
        if([@"iPhone_X" isEqualToString:deviceModelName]||[@"iPhone_XS"  isEqualToString:deviceModelName]||[@"iPhone_XS_MAX" isEqualToString:deviceModelName]||[@"iPhone_XR" isEqualToString:deviceModelName]){
            mBottomConstraintTextView.constant = -(kDefaultBottomTextView_SupView+[mFaceView intrinsicContentSize].height+34);
        }else{
            mBottomConstraintTextView.constant = -(kDefaultBottomTextView_SupView+[mFaceView intrinsicContentSize].height+0);
        }
...
#pragma mark emojiViewSelectDelegate
